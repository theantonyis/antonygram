...
const Register = () => {
    ...
    return (
        <>
            ...
            <Container className="register-page bg-light d-flex justify-content-center align-items-center vh-100 px-3">
                <Row className="w-100 w-md-50 bg-white p-5 rounded-lg shadow-lg">
